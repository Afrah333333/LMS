...
class TeacherRegisteryDesktop extends StatefulWidget {
  const TeacherRegisteryDesktop({super.key});

  @override
  State<TeacherRegisteryDesktop> createState() => _TeacherRegisteryDesktopState();
}

class _TeacherRegisteryDesktopState extends State<TeacherRegisteryDesktop> {
